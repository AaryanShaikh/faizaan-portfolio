        ...
        <div style={{ height: "937px", width: "100%", display: "flex", justifyContent: 'center', alignItems: 'center' }}>
            <div style={{ width: "90%" }}>
                ...
                <div style={{ display: "flex", gap: 70, marginTop: "35px", position: "relative" }}>
                    ...
                    <div style={{ width: "55%", fontFamily: "Poppins", fontWeight: 400, fontSize: "24px", lineHeight: "40.56px", height: "615px", display: "flex", alignItems: "center", position: "relative", zIndex: 2 }}>
