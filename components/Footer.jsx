...
const Footer = () => {
    ...
    return (
        <>
            {
                deviceType == "mobile" ? <div style={{ height: "466px", background: "#D92C24" }}>
                    <div style={{ height: "90%", display: "flex", justifyContent: "center", flexDirection: "column", gap: 30 }}>
                        <div style={{ height: "22px" }}>
                            <Image src={logo} style={{ height: "100%", width: "100%", objectFit: "contain" }} />
                        </div>
                        <div style={{ display: "flex", width: "100%", justifyContent: "space-around" }}>
                            <div style={{ display: "flex", gap: 40, justifyContent: "center", fontFamily: "Poppins", fontWeight: 400, fontSize: "14px", lineHeight: "16.41px", color: "#fff", flexDirection: "column" }}>
                ...
                </div> : <div style={{ height: "300px", background: "#D92C24" }}>
